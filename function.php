...
function register(){
    ...
    global $db, $errors, $email,$fullnames,$contact, $location ,$password;
   ...
   //$username    =  e($_POST['username']);
    ...
    if (count($errors) == 0) {
        ...
        if (isset($_POST['user_type'])) {
            ...
            $query = "INSERT INTO users (fullnames, email, contact, location, user_type, password, code, status) 
                      VALUES('$fullnames', '$email', '$contact','$location','$user_type', '$password', '$code','$status')";
			...
			$query = "INSERT INTO users (fullnames, email, contact, location,user_type, password, code, status) 
					  VALUES('$fullnames', '$email','$contact','$location' ,'user', '$password', '$code','$status')";
			$data_check=mysqli_query($db, $query);
			if($data_check){
				$subject = "Email Verification Code";
				$message = "Your verification code is $code";
