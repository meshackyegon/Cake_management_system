...
<style>
  ...
  <div class="nav">
      <ul>
        <li style="margin-right:40px;"><a style=" color: white; font-size:18px; " href="cart.php">Cart</a></li>
        <li style="margin-right:40px;" ><a style=" color: white; font-size:18px; "href="order.php">Order cake</a></li>
        <li style="margin-right:40px;" ><a style=" color: white; font-size:18px; "href="profile.php">Profile</a></li>
        <li style="margin-right:40px;"><a style=" color: white; font-size:18px; " href="change_password.php">Change password</a></li>
        <li style="margin-right:40px;"><a style=" color: white; font-size:18px; " href="logout.php">Logout</a></li>
        <?php
